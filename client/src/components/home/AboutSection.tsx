        ...
        <div className="flex flex-col md:flex-row gap-12 items-center">
          <div className="md:w-1/2">
            ...
            <p className="text-lg mb-6 leading-relaxed text-gray-700">
              Buddha Dhaam is devoted to preserving the sacred teachings of Buddhism by serving monks and safeguarding Dharma. Across the holy sites of Bodhgaya, Varanasi, Lumbini, and Kushinagar, we provide <span className="text-orange-700 font-semibold">food, shelter, medical aid, and essential resources</span> to monks and monasteries.
            </p>
            <p className="text-lg mb-6 leading-relaxed text-gray-700">
              Our work includes <span className="text-orange-700 font-semibold">restoring ancient temples, planting sacred Bodhi trees, and organizing traditional chanting ceremonies</span> that maintain the spiritual legacy of the Buddha's teachings.
            </p>
            <p className="text-lg mb-8 leading-relaxed text-gray-700">
              We are committed to <span className="text-orange-700 font-semibold">supporting both resident and traveling monks</span> through mindful initiatives that honor the timeless wisdom of Buddhist traditions.
            </p>
            <Link href="/about">
